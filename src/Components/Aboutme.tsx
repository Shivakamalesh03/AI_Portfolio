    ...
    return (
     ...
     <div className="bg-white dark:bg-gray-900 shadow-2xl dark:shadow-lg dark:shadow-gray-800 rounded-2xl p-10 max-w-5xl w-full mx-auto min-h-[600px] flex flex-col">
       ...
       <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
         <img src={slowlaxImage} alt="Shrishvesh Reddy" className="w-40 h-40 rounded-full border-4 border-gray-700 dark:border-gray-600" />
         <div>
           <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-200">Shrishvesh Reddy</h3>
       ...
       <p className="text-lg text-gray-800 dark:text-gray-300 leading-relaxed mt-6">
         I am an Electrical Engineering undergraduate at IIT Roorkee, passionate about building software solutions. I enjoy working with Rust, Web3, and distributed systems. Currently, I am contributing to GCC Rust and exploring compiler technologies. When I'm not coding, you'll find me organizing events, playing music, or exploring new tech trends.
       </p>
       ...
       <div className="mt-8">
         ...
         <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
           {["Rust", "C++", "React", "Solidity", "MongoDB", "Axum"].map((skill) => (
       ...
       <div className="mt-8">
         ...
         <p className="text-lg text-gray-800 dark:text-gray-300 leading-relaxed">
           I love organizing events, listening to music, and exploring cybersecurity. Always excited to collaborate on innovative projects!
         </p>
       </div>
     </div>
   </div>
